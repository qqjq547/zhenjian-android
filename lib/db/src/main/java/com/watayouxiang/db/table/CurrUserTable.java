...
public class CurrUserTable {
    ...
    public CurrUserTable(String avatar, String avatarbig, String createtime, String domain,
            ...
            String loginname, boolean mg, int msgremindflag, String nick, String phone, String reghref,
            int registertype, String remark, int searchflag, int sex, String sign, int status,
            int thirdstatus, String updatetime, int xx, List<String> roles) {
        this.avatar = avatar;
