...
public class AccountRegisterResp  {
    ...
    private int id;
    private AccountRegisterResp.UserBean user;
    ...
    public AccountRegisterResp.UserBean getUser() {
        return user;
    }

    public void setUser(AccountRegisterResp.UserBean user) {
        this.user = user;
    }
    ...
    public static class UserBean {
        ...
        private PhoneRegisterResp.UserBean.IpInfoBean ipInfo;
        private int ipid;
        private String loginname;
        private boolean mg;
        private String nick;
        ...
        public PhoneRegisterResp.UserBean.IpInfoBean getIpInfo() {
            return ipInfo;
        }

        public void setIpInfo(PhoneRegisterResp.UserBean.IpInfoBean ipInfo) {
            this.ipInfo = ipInfo;
        }
