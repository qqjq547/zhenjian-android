 ...
 * desc :
 */
public class UploadVideo2NewReq extends BaseReq<Object> {
    ...
    public UploadVideo2NewReq(String chatlinkid, String videoPath, int width, int height, String coverurl, String duration, String fingerprint,String filefingerprint) {
        ...
        Log.d("===视频已存在参数===","=="+toString() );

    }

    @Override
    public String toString() {
        return "UploadVideo2NewReq{" +
