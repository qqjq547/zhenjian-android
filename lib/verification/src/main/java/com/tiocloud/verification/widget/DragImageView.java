...
import com.tiocloud.verification.utils.DisplayUtil;
...
public class DragImageView extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public void reset() {
        ...
        drag_sb.setProgressDrawable(getResources().getDrawable(R.drawable.vercode_drag_seek_progress));
    ...
    public void hideFlashImage() {
        drag_v_flash.setVisibility(INVISIBLE);
    }
    ...
    public void ok() {
        ...
        drag_sb.setProgressDrawable(getResources().getDrawable(R.drawable.vercode_drag_seek_progress_success));
    ...
    public void fail() {
        ...
        drag_sb.setProgressDrawable(getResources().getDrawable(R.drawable.vercode_drag_seek_progress_fail));
    }
