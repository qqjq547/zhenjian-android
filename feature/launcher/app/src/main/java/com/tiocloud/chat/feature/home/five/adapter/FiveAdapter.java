package com.tiocloud.chat.feature.home.five.adapter;
 ...
 * desc :
 */
public class FiveAdapter extends BaseQuickAdapter<FoundListResp.Found, BaseViewHolder> {
    ...
    public FiveAdapter(RecyclerView recyclerView) {
