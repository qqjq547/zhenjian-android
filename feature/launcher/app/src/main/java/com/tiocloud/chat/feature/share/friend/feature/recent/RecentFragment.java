...
import com.tiocloud.chat.databinding.FragmentShareSessionRecentBinding;
...
public class RecentFragment extends TioFragment {
    ...
    private FragmentShareSessionRecentBinding binding;
    private RecentAdapter recentAdapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentShareSessionRecentBinding.inflate(inflater, container, false);
