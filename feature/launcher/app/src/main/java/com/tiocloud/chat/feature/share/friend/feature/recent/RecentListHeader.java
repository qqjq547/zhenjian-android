...
import com.tiocloud.chat.databinding.HeaderShareSessionRecentBinding;
...
public class RecentListHeader extends RelativeLayout {
    ...
    public RecentListHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.header_share_session_recent, this, true);
    }
}
